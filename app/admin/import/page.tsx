      ...
      <div className="p-6 bg-white dark:bg-slate-900 rounded-lg shadow border dark:border-slate-800">
        ...
        <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 text-blue-700 dark:text-blue-300">
          ...
          <ol className="list-decimal list-inside text-sm space-y-1">
            ...
            <li>
              حقل <span className="font-mono" dir="ltr">specs</span> <b>يُدمج</b> مع الموجود:
              أرسل ما تريد تغييره وحده، والباقي يبقى. والحذف بقيمةٍ فارغة صريحة.
            </li>
            <li>
              ⚠️ ولذلك تُرفض المفاتيح التي لا يعرفها المخطّط: الغلطة المطبعيّة
              (<span className="font-mono" dir="ltr">sockett</span>) كانت تُمسك لأنها تُسقط الأصل،
              وبعد الدمج تمرّ بلا أثر لو لم تُحصر المفاتيح.
            </li>
          </ol>
        </div>
