    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#0B1120] pb-20 transition-colors duration-300 overflow-x-hidden selection:bg-blue-500/20">
      ...
      <div className="relative w-full h-[50vh] md:h-[65vh] bg-slate-900 border-b border-slate-200 dark:border-slate-800/80 flex items-end">
        ...
        <div className="absolute top-6 right-4 sm:right-6 lg:right-12 z-20">
          <Link href="/news" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-sm bg-white/80 dark:bg-[#0B1120]/80 backdrop-blur-md border border-slate-200/50 dark:border-slate-700/50 text-slate-700 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-500/50 transition-all shadow-lg group">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-32 md:pb-40">
          <div className="flex flex-wrap items-center gap-4 mb-6">
            <span className="px-3 py-1.5 bg-blue-600 text-white text-[12px] font-black uppercase tracking-widest rounded-sm shadow-md shadow-blue-600/20">
              {news.category}
            </span>
