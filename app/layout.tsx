...
export const metadata: Metadata = {
  ...
  /* ⚠️ لا تضع canonical هنا إطلاقاً.
     كان `canonical: '/'` في الجذر يُورَّث لكل صفحة لا تعرّف canonical خاصاً،
     فكانت ٢٥٠ صفحة (كل القطع والأخبار) تخبر جوجل: "أنا نسخة من الرئيسية".
     النتيجة: موقع يبدو بصفحة واحدة، وتناقض صريح مع sitemap الذي يعلن ٢٥٠ —
     وهذا وحده كافٍ لرفض AdSense. كل صفحة تعرّف canonical الخاص بها الآن. */
  openGraph: {
    type: 'website',
    locale: 'ar_SA',
