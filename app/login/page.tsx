...
const PERKS = [
  ...
  /* ⚠️ كان هنا «يصلك خبر نزول السعر» — وهو **وعدٌ لا يقع**: لا رصدَ
     لكل مستخدمٍ على حدة، ولا مزوّد بريدٍ في الإعداد أصلاً. إشعارات
     انخفاض السعر تصل الإدارة على ديسكورد لا المستخدم.
     فصار النصّ ما يقع فعلاً: أسعار تجميعتك تُقرأ لحظياً عند فتحها،
     وتُقارَن بمجموعها السابق. */
  {
    icon: 'M3 3v18h18M7 14l4-4 4 4 5-6',
    title: 'أسعار تجميعتك تتحدّث وحدها',
    body: 'تفتحها بعد شهر فترى سعر اليوم لا سعر يوم حفظتها — ومجموعها محسوباً من جديد.',
  },
  {
