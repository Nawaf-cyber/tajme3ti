  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8">
      ...
      <div className="w-full lg:w-72 shrink-0 h-fit lg:sticky lg:top-6">
        <div className="bg-white/70 dark:bg-[#0F172A]/70 backdrop-blur-sm p-6 rounded-3xl border border-slate-200 dark:border-slate-800/80 shadow-sm flex flex-col gap-8">
          
          <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800/60 pb-5">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-cyan-50 dark:bg-cyan-900/20 flex items-center justify-center text-cyan-600 dark:text-cyan-400 border border-cyan-100 dark:border-cyan-800/30 shadow-sm">
          ...
          <div className="bg-slate-50 dark:bg-[#0B1120] p-4 rounded-2xl border border-slate-200 dark:border-slate-700/60">
            ...
            <input 
              ...
              className="w-full h-2 bg-slate-200 dark:bg-slate-700 rounded-lg appearance-none cursor-pointer accent-cyan-600 dark:accent-cyan-500 hover:accent-cyan-500 transition-all"
            />
            ...
            {visible.map((comp) => {
              ...
              <div key={comp.id} className={`group relative bg-gradient-to-b from-white/80 to-white/60 dark:from-[#0F172A]/70 dark:to-[#0B1120]/50 backdrop-blur-sm border-t-2 shadow-sm hover:shadow-xl hover:shadow-cyan-500/15 hover:-translate-y-1 transition-all duration-300 flex flex-col overflow-hidden rounded-sm ${available ? 'border-t-cyan-500 border-x border-b border-slate-200 dark:border-slate-800' : 'border-t-amber-500 border-x border-b border-amber-300 dark:border-amber-600/50'}`}>
                ...
                <div className="flex justify-between items-center px-4 pt-3 pb-2">
                  ...
                  <span className="font-mono text-[9px] font-black text-cyan-600 dark:text-cyan-400 border border-cyan-500/40 px-2 py-0.5 rounded-sm uppercase tracking-widest">
                    {comp.category?.name}
                  </span>
                </div>
