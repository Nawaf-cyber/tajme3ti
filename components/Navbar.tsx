      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <Link href="/guides" className="text-sm font-bold text-slate-600 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 px-3 py-2 rounded-xl transition-all flex items-center gap-1.5">
            ...
            <Link href="/compare" className="text-slate-700 dark:text-slate-300 hover:text-cyan-600 dark:hover:text-cyan-400 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 px-4 py-2 rounded-xl transition-colors font-bold text-sm">
              قارن القطع
            </Link>

            <Link href="/deals" className="text-sm font-bold text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-900/20 px-3 py-2 rounded-xl transition-all flex items-center gap-1.5">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-slate-200/60 dark:border-slate-800/60 flex flex-col gap-2 animate-in slide-in-from-top-4 duration-200">
            ...
            <Link href="/guides" onClick={() => setIsMobileMenuOpen(false)} className="text-sm text-slate-700 dark:text-slate-200 font-bold flex items-center gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 rounded-xl transition-colors">
